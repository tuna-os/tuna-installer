...
from tuna_installer.core.timezones import (
    all_timezones,
    get_location,
...
@Gtk.Template(resource_path="/org/tunaos/Installer/gtk/widget-timezone.ui")
...
@Gtk.Template(resource_path="/org/tunaos/Installer/gtk/default-timezone.ui")
