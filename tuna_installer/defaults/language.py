...
from tuna_installer.core.languages import all_languages, current_language


@Gtk.Template(resource_path="/org/tunaos/Installer/gtk/widget-language.ui")
...
@Gtk.Template(resource_path="/org/tunaos/Installer/gtk/default-language.ui")
