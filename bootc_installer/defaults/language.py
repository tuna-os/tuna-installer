...
from bootc_installer.core.languages import all_languages, current_language


@Gtk.Template(resource_path="/org/bootcinstaller/Installer/gtk/widget-language.ui")
